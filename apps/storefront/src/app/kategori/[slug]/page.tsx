...
const mockCategoryProducts = [
  ...
  {
    id: '3',
    name: 'Gümüş Aynalı Pleksi "Happy Birthday" Süsü',
    slug: 'gumus-aynali-pleksi-happy-birthday-susu',
    category: 'Pasta Süsleri',
    price: 49.90,
    discountPrice: null,
    rating: 4.8,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-4 border border-[#ECE0DD] flex items-center justify-between text-xs">
              <span className="text-[#554244] font-medium">Toplam <strong className="text-[#201A19]">4</strong> ürün listeleniyor</span>
